 ...
 * @ORM\Entity(repositoryClass="AcmeGroup\LaboBundle\Entity\typeEmailRepository")
 * @UniqueEntity(fields={"nom", "version", "statut"}, message="Ce type d'email existe déjà")
 */
class typeEmail extends baseType {
...
// DEBUT --------------------- à inclure dans toutes les entités ------------------------
	 ...
	 * @Assert\True(message = "Ce type d'email n'est pas valide.")
	 * @return boolean
	 */
