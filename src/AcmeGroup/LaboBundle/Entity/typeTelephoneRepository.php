...
/**
 * typeTelephoneRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class typeTelephoneRepository extends baseLaboRepository {

	const DEFAULT_TYPE_TELEPHONE 	= "telephone";
	...
	public function defaultVal($defaults = null, $onlyOneObject = false, $champ = 'nom') {
		// valeurs spécifiques
		if($defaults === null) $defaults = array(self::DEFAULT_TYPE_TELEPHONE);
		// $champ = 'slug';
