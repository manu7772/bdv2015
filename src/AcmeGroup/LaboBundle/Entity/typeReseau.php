 ...
 * @ORM\Entity(repositoryClass="AcmeGroup\LaboBundle\Entity\typeReseauRepository")
 * @UniqueEntity(fields={"nom", "version", "statut"}, message="Ce type de réseau existe déjà")
 */
class typeReseau extends baseType {
...
// DEBUT --------------------- à inclure dans toutes les entités ------------------------
	 ...
	 * @Assert\True(message = "Ce type de réseau n'est pas valide.")
	 * @return boolean
	 */
